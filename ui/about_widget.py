...
class AboutWidget(QWidget):
    ...
    back_clicked = Signal()    # ДОБАВЛЕНО: Недостающий сигнал
    ...
    def update_translations(self):
        ...
        if self.title_label:
            self.title_label.setText(translation.t("about.title", "SIBERIA-SOFTWARE- Симулятор кибербезопасности"))
            ...
            <tr>
                ...
                <td>
                    ...
                    <div style="color: #cccccc;">
                        <b>«SIBERIA-SOFTWARE»</b> — это симулятор работы в сфере кибербезопасности. 
    ...
    def go_back(self):
        ...
        # Эмитим оба сигнала для совместимости
        self.back_requested.emit()
        self.back_clicked.emit()  # ДОБАВЛЕНО: Новый сигнал