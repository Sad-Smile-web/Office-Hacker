...
def main():
    ...
    app.setApplicationName(translation.t("app.name", "SIBERIA-SOFTWARE"))
    app.setApplicationVersion("0.5")
    app.setApplicationDisplayName(translation.t("app.title", "SIBERIA-SOFTWARE - СИМУЛЯТОР КИБЕРБЕЗОПАСНОСТИ"))
