...
class SimpleTranslation:
    ...
    def load_builtin_translations(self, language):
        ...
        builtin_translations = {
            ...
            "de": {
                ...
                "game": {
                    "input_name_title": "Mitarbeiterregistrierung",
            ...
            "la": {
                "menu": {
                    ...
                    "new_game": "NOVA LUDUS",
                    "load_game": "CARGA LUDUM",
                    "settings": "INSTITUTIONES",
                    "about": "DE PROGRAMA",
                    "help": "AUXILIUM",
                    "exit": "EXITUS"
                },
                "game": {
                    "input_name_title": "Registratio operarii",
                    "input_first_name": "Nomen:",
                    "input_last_name": "Cognomen:",
                    "ok": "OK",
                    "cancel": "Cancellare"
                }
            },
            "fr": {
                ...
                "game": {
                    "input_name_title": "Enregistrement de l'employé",
    ...
    def get_available_languages(self):
        ...
        for lang in ["ru", "en", "de", "sp", "la", "fr", "zh", "ja"]:
